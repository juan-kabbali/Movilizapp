...
public class perfilConductorActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new DrawerItem(tagTitles[0], R.drawable.icono_perfil_publico));
        items.add(new DrawerItem(tagTitles[1], R.drawable.icono_buscar_rutas));
        items.add(new DrawerItem(tagTitles[2], R.drawable.icono_solicitudes));
        items.add(new DrawerItem(tagTitles[3], R.drawable.icono_historial));
        items.add(new DrawerItem(tagTitles[4], R.drawable.icono_informacion));
